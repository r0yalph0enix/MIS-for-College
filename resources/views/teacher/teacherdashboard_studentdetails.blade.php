        ...
        <div>
            <div class="user-details-container">
                <div class="user_details">
                    <h5>First Name</h5>
                    <input type="text" value="Diwash" readonly>
                </div>
                <div class="user_details">
                    <h5>Middle Name</h5>
                ...
                <div class="user_details">
                    <h5>Last Name</h5>
                    <input type="text" value="Thapa" readonly>
                </div>
            </div>
            <div class="user-details-container">
                <div class="user_details">
                    <h5>Email</h5>
                    <input type="text" value="Diwash@gmail.com" readonly>
                </div>
                <div class="user_details">
                    <h5>Date of Birth</h5>
            ...
            <!-- Address Details -->
                ...
                <div>
                    ...
                    <div class="user-details-container">
                        <div class="user_details">
                            <h5>Father's Name</h5>
                            <input type="text" value="Ram Thapa" readonly>
                        </div>
                        <div class="user_details">
                            <h5>Mother's Name</h5>
                            <input type="text" value="Sita Thapa" readonly>
                        </div>
                    </div> 
                    <div class="user-details-container">
                        <div class="user_details">
