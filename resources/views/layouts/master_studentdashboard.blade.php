...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" />
     ...
     <link rel="stylesheet" href={{asset('student/css/student_dashboard.css')}} />
     <!-- External link of js -->
     <script defer src={{asset('student/js/jquery.js')}}></script>  
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="/studentdashboard" class="list-group-item list-group-item-action bg-transparent second-text active">
                    <i class="fas fa-tachometer-alt me-2"></i>Dashboard</a>
                <a href="/studentdashboard_teachers" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                    <i class="fa fa-user me-2"></i>Teachers</a>
                <a href="/studentdashboard_subjects" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                    <i class="fa fa-book me-2"></i>Subjects</a>
                <a href="/studentdashboard_resources" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                    <i class="fa fa-server me-2"></i>Resources</a>
                <a href="/studentdashboard_comment&query" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                    <i class="fa fa-comments me-2"></i>Comment/Query</a>
                <a href="{{asset('student/img/Help.pdf')}}" target="_blank" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="/studentdashboard_view_profile">View Profile</a></li>
                            <li><a class="dropdown-item" href="/studentdashboard_edit_profile">Edit Profile</a></li>
                            <li><a class="dropdown-item" href="/studentdashboard_password_reset">Reset Password</a></li>
